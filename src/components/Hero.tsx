    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-20 container mx-auto px-4 md:px-6 h-full flex flex-col justify-center">
        <div className="max-w-3xl">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-white font-montserrat font-bold leading-tight mb-6 animate-fade-in">
            Scalable Carbon Solutions for a Sustainable Future
          </h1>
          <h3 className="text-xl md:text-2xl text-gray-200 font-light mb-8 animate-fade-in" style={{ animationDelay: '0.3s' }}>
            Waste to Carbon to Soil to Lives.
          </h3>
          <Button 
            className="bg-white text-black hover:bg-gray-200 rounded-none px-8 py-6 text-lg animate-fade-in"
