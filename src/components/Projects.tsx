      ...
      <div className="container mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <Button className="bg-primary text-primary-foreground hover:bg-primary/80 rounded-none px-8 py-6">
              View Projects
            </Button>
          </div>
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 w-2/3 h-24 bg-background flex items-center justify-center">
